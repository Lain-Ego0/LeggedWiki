...
This page provides a quick index by **topic / method**. For detailed notes, see:
[ETH-RSL.en.md](<ETH-RSL.en.md>), [KAIST.en.md](<KAIST.en.md>), [其他.en.md](<其他.en.md>), [人形.en.md](<人形.en.md>), [综述.en.md](<综述.en.md>).
